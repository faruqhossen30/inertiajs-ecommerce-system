import PostSlider from '@/Components/Frontend/Products/PostSlider'
                    ...
                    <Tab.Group selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                        <div className="border-b">
                            <Tab.List as='div' className="space-x-3 text-gray-500 ">
                                <Tab className={true && 'text-lg font-bold text-green-500 border-b-4 border-b-green-500 py-2'}>Deatils</Tab>
                                <Tab>Review</Tab>
                                <Tab>Info</Tab>
                            </Tab.List>
                        </div>
