                    ...
                    categories.map((category, index) => {
                        return <div className="container mx-auto">
                            <div className="flex justify-between py-5">
                                <h4 className="text-xl font-bold text-emerald-500 border-b-4 border-b-emerald-400 capitalize">{category.name}</h4>
                                <Link href={route('productpage', {'cat[]':category.id})} className="text-emerald-500">View All</Link>
                            </div>
